                        ...
                        <div className="max-w-5xl mx-auto">
                                  <div className="text-center mb-12">
                                              ...
                                              <p className="text-gray-500 max-w-2xl mx-auto">
                                                            Reviews tell clients if a trainer is good. Compatibility matching tells them if a trainer is right <em>for them</em>. That&apos;s a better lead — and a longer client relationship.
                                              </p>
                                  </div>
            ...
            },
            {
                              ...
                              desc: 'See how many clients your profile was surfaced to, your average match score, and which compatibility dimensions are driving the most interest.',
                                        ...
                                        <div key={item.title} className="bg-gray-50 rounded-2xl p-6">
                                                        ...
                                                        <h3 className="font-bold text-[#03243F] mb-2">{item.title}</h3>
            ...
            },
            {
                              ...
                              desc: 'Clients who contact you already fit your profile. Free trainers get their first lead free, then $15/lead. Pro and Elite get unlimited leads.',
                                        ...
                                        <div key={step.n} className="text-center">
                                                        ...
                                                        <h3 className="text-lg font-bold text-[#03243F] mb-2">{step.title}</h3>
                                    ...
                                    {/* Free */}
                                              <div className="rounded-2xl p-8 bg-gray-50">
                                                            ...
                                                            <div className="flex items-end gap-1 mb-4">
                                                                            <span className="text-4xl font-bold text-[#03243F]">$0</span>
                                                                            <span className="text-sm mb-1 text-gray-400">forever</span>
                                                            </div>
                              ...
                              '$15/lead after that',
                                    ...
                                    {/* Pro */}
                                              <div className="rounded-2xl p-8 bg-[#03243F] text-white ring-4 ring-[#18A96B] relative">
                                                            ...
                                                            <p className="text-[#F4A636] text-sm font-semibold mb-4">$29/mo founding price</p>
                                                            <ul className="space-y-2 mb-8">
                                                              {[
                              'Unlimited leads',
            ...
            },
            {
                              ...
                              a: 'Yes. No contracts, no cancellation fees. Cancel anytime from your dashboard.',
                                        ...
                                        <div key={i} className="bg-white rounded-2xl p-6">
                                                        <h3 className="font-bold text-[#03243F] mb-2">{item.q}</h3>
            ...
            {/* Footer */}
                <footer className="bg-[#02192d] text-gray-400 py-8 px-6">
                        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
                                  ...
                                  <p className="text-sm">© 2026 MyTrustedTrainer</p>
                        </div>
                </footer>
          </div>
        )
